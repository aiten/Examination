...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistence.Model.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.Class", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.StudentSubtask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.Subtask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Persistence.Model.Teacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassCourse", b =>
                {
                    b.HasOne("Persistence.Model.Class", null)
                        .WithMany()
                        .HasForeignKey("ClassesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Persistence.Model.Course", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ClassStudent", b =>
                {
                    ...
                    b.HasOne("Persistence.Model.Student", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CourseTeacher", b =>
                {
                    ...
                    b.HasOne("Persistence.Model.Teacher", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Persistence.Model.Class", b =>
                {
                    b.HasOne("Persistence.Model.Teacher", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Persistence.Model.Course", b =>
                {
                    b.HasOne("Persistence.Model.Subject", "Subject")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Persistence.Model.StudentSubtask", b =>
                {
                    b.HasOne("Persistence.Model.StudentExam", "StudentExam")
                        .WithMany("StudentSubtasks")
                        .HasForeignKey("StudentExamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Persistence.Model.Subtask", "Subtask")
                        .WithMany("StudentSubtasks")
